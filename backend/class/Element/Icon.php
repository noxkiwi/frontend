...
final class Icon extends Italic
{
    ...
    public const  ICON_COINS               = [self::OPTION_STYLE => self::STYLE_LIGHT,   self::OPTION_ICON => 'fa-coins', self::OPTION_SIZE => self::SIZE_LG, self::OPTION_COLOR => Bootstrap::TEXT_SUC];
    ...
    public const  ICON_DISC                = [self::OPTION_STYLE => self::STYLE_LIGHT,   self::OPTION_ICON => 'fa-disc-drive', self::OPTION_SIZE => self::SIZE_LG, self::OPTION_COLOR => Bootstrap::TEXT_PRI];
    ...
    public const  ICON_DELETE              = [self::OPTION_STYLE => self::STYLE_LIGHT,   self::OPTION_ICON => 'fa-trash', self::OPTION_SIZE => self::SIZE_LG, self::OPTION_COLOR => Bootstrap::TEXT_DNG];
    ...
    public const  ICON_SHOPPING_CART       = [self::OPTION_STYLE => self::STYLE_LIGHT,   self::OPTION_ICON => 'fa-shopping-cart', self::OPTION_SIZE => self::SIZE_LG, self::OPTION_COLOR => Bootstrap::TEXT_SUC];
    public const  ICON_EBAY                  = [self::OPTION_STYLE => self::STYLE_BRAND,   self::OPTION_ICON => 'fa-ebay', self::OPTION_SIZE => self::SIZE_LG, self::OPTION_COLOR => Bootstrap::TEXT_DNG];
    ...
    public const  ICON_FILM                = [self::OPTION_STYLE => self::STYLE_LIGHT,   self::OPTION_ICON => 'fa-film', self::OPTION_SIZE => self::SIZE_LG, self::OPTION_COLOR => Bootstrap::TEXT_DNG];
    public const  ICON_FILTER              = [self::OPTION_STYLE => self::STYLE_LIGHT,   self::OPTION_ICON => 'fa-filter', self::OPTION_SIZE => self::SIZE_LG, self::OPTION_COLOR => Bootstrap::TEXT_SUC];
    ...
    public const  ICON_GIT                 = [self::OPTION_STYLE => self::STYLE_BRAND,   self::OPTION_ICON => 'fa-git-alt', self::OPTION_SIZE => self::SIZE_LG, self::OPTION_COLOR => Bootstrap::TEXT_WRN];
    ...
    public const  ICON_BOXES               = [self::OPTION_STYLE => self::STYLE_SOLID,   self::OPTION_ICON => 'fa-boxes', self::OPTION_SIZE => self::SIZE_LG, self::OPTION_COLOR => Bootstrap::TEXT_PRI];
    public const  ICON_WAREHOUSE           = [self::OPTION_STYLE => self::STYLE_SOLID,   self::OPTION_ICON => 'fa-warehouse', self::OPTION_SIZE => self::SIZE_LG, self::OPTION_COLOR => Bootstrap::TEXT_PRI];
